export default {
  ...
  fields: [
    ...
    },
    {
      ...
      title: 'Peso (kg)',
      type: 'number',
      description: 'Peso de la pieza empaquetada, en kilogramos. Ej: 0.35. Necesario para cotizar envíos.',
    ...
    },
    {
      ...
      title: 'Alto (cm)',
      type: 'number',
      description: 'Alto del paquete en centímetros. Necesario para cotizar envíos.',
      validation: Rule => Rule.min(0),
    },
    {
      name: 'ancho',
      title: 'Ancho (cm)',
      type: 'number',
      description: 'Ancho del paquete en centímetros. Necesario para cotizar envíos.',
      validation: Rule => Rule.min(0),
    },
    {
      name: 'largo',
      title: 'Largo (cm)',
      type: 'number',
      description: 'Largo del paquete en centímetros. Necesario para cotizar envíos.',
      validation: Rule => Rule.min(0),
    },
    {
      name: 'disponible',
